...
def test_publication_state_matches_the_recorded_trigger() -> None:
    ...
    published = {
        ...
        # published 2026-09-04 after the semantic corrections, the real-document
        # acceptance review, the dependency-graph pin, and the package-matrix
        # re-verification all passed. Unpublishing either requires new
        # governance, not a diff.
        ("portfolio-review", "v1"),
        ("portfolio-review", "v2"),
    }
