...
#let empty-state(message, size: 8.8pt) = text(size: size, fill: slate)[#message]
#let body-strong(value) = text(size: 9.5pt, weight: 500, fill: ink)[#value]
#let small-caps(value) = text(size: 6.8pt, weight: 600, tracking: 0.22pt, fill: slate)[#value]
