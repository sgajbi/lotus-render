...
#import "_design.typ": TONE_PALETTE, accent, accent-soft, document-face, document-title, gain, ink, loss, mist, navy, rule, section-head, slate, text-body, text-body-strong, text-caption, text-cover, text-fine, text-head, text-lead, text-micro, text-page-title, text-small
...
#let section-title(value) = text(size: text-page-title, weight: 300, fill: navy)[#value]
