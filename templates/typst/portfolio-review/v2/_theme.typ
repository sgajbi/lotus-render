...
#import "_design.typ": TONE_PALETTE, accent, accent-soft, document-title, gain, ink, loss, mist, navy, rule, section-head, slate, text-body, text-body-strong, text-caption, text-cover, text-fine, text-head, text-lead, text-micro, text-section, text-small
